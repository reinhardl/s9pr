...
{if $is_raw_mode != true}
    {if $template_option.use_corenav}
        ...
        <nav class="navbar navbar-default navbar-custom navbar-fixed-top"  >
            ...
            {if $footer_prev_page} 			<a class="navbar-brand" href="{$footer_prev_page}"><i class="fa fa-arrow-left" aria-hidden="true"></i>  </a> {/if}
            {if $footer_next_page} <a class="navbar-brand" href="{$footer_next_page}"> <i class="fa fa-arrow-right" aria-hidden="true"></i></a> {/if}
...
{* MAIN CONTENT *}
    <main id="maincontent" class="container" >
        <div class="row">
			...
			<div class=" col-md-3 sidebarPadding">
